            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {['section1', 'section2'].map((sectionKey) => (
                  <div key={sectionKey} className="flex flex-col gap-2 p-4 rounded-xl bg-emerald-50/30 border border-emerald-100/50">
              ...
              <div className="flex flex-col gap-4">
                <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest pl-1">{t('workflow')}</h4>
                  ...
                  {['step1', 'step2', 'step3'].map((step, idx) => (
                    <div key={step} className="flex items-center gap-2 shrink-0">
                      <div className="flex flex-col items-center gap-1">
                        ...
                        <span className="text-[10px] font-bold text-slate-500 whitespace-nowrap">{t(`${currentType}.${step}`)}</span>
                      </div>
                      {idx < 2 && (
